...
<body>
    <div class="container my-5">
        ...
        <h1 class="text-center mb-3">Available Doctors <i class="fa-solid fa-user-doctor"></i>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Fees : <i class="fa-solid fa-indian-rupee-sign"></i> ' . $fee . '.00</h5>
                        <a href="doctordelete.php?deleteid=' . $id . '" class="text-light text-decoration-none"><button class="btn btn-danger w-100">Delete Account</button></a>
