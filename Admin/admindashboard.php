...
if (!isset($_SESSION['username'])) {
    header('locaton:../LogSign/adminlogin.php');
}
        ...
        <div class="sidebar">
            <ul>
                ...
                <a href="viewdoctor.php" class="text">
                    <li id="home">View Doctors</li>
                </a>
                <a href="viewpatient.php" class="text">
                    <li id="book-appointment">View Patients</li>
                </a>
                <a href="viewappointments.php" class="text">
                    <li id="appointment">View Appointments</li>
                </a>
